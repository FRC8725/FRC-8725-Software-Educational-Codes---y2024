...
public class GamepadJoystick extends XboxController {
    // Limit Swerve acceleration
    private final SlewRateLimiter translateLimiter = new SlewRateLimiter(SwerveConstants.MAX_ACCLERATION);
    private final SlewRateLimiter rotationLimiter = new SlewRateLimiter(SwerveConstants.MAX_ANGULAR_ACCLERATION);
